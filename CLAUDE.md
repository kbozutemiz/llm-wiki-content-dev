...
This workspace serves two distinct functions, each fully defined in its own skill. This file only routes to them — it deliberately holds no operational detail, so neither function's instructions weigh on the other.
