---
name: wiki-ops
description: "Research Wiki agent for maintaining, growing, and querying Bugra's structured knowledge base — ingest sources, query the wiki, lint, and maintain interlinked pages under raw/, wiki/, index.md, and log.md."
---
